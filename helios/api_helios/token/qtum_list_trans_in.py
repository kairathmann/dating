...
class QtumListTransfersIn(AbstractHeliosEndpoint):

    @newrelic.agent.function_trace()
    def post(self, request, **kwargs):
        """
            Returns a list of all transfers into a User's inbound QTUM address. This is intended to be
            shown on the same screen as where they view their inbound address. It's implemented as a separate
            endpoint because eventually we're going to have to paginate this data.
                    ...
                    "data": {
                        ...
                        "items": [

                            {
                                ...
                                "amount": "5.0000741",              // Amount is always POSITIVE
        ...
        return self.render_response(
            ...
            data={
                ...
                } for item in JournalIn.objects.filter(user=target).order_by('-created')]
            }
        )
