  ...
  1: [ function (t, n, e) {
    ...
    try {
      o = localStorage.getItem('__nr_flags')
        .split(','), console && 'function' == typeof console.log && (s.console = !0, o.indexOf('dev') !== -1 && (s.dev = !0), o.indexOf(
        'nr_dev') !== -1 && (s.nrDev = !0))
    } catch (c) {
    }
    ...
    var i = t('handle'), a = t(16), s = t('ee'), c = t('loader'), f = t('gos'), u = window.onerror, d = !1,
      l = 'nr@seenError', p = 0
    ...
    if (window.performance && window.performance.timing && window.performance.getEntriesByType) {
      ...
      }, !1)), document[ f ]('scroll', r, { passive: !0 }), document[ f ]('keypress', r, !1), document[ f ]('click',
        r,
        !1)
    }
  }, {} ], 5: [ function (t, n, e) {
    ...
    n.exports = a, 'getPrototypeOf' in Object ? (r(document), r(window), r(f.prototype)) : f.prototype.hasOwnProperty(u) && (o(
      window), o(f.prototype)), a.on(u + '-start', function (t, n) {
    ...
    n.exports = r, o.inPlace(window, [ 'r' + i, 'mozR' + i, 'webkitR' + i, 'msR' + i ], 'raf-'), r.on('raf-start',
      function (t) {
        t[ 0 ] = o(t[ 0 ], 'fn-')
      })
  }, {} ], 8: [ function (t, n, e) {
    ...
    var i = t('ee').get('timer'), a = t(18)(i), s = 'setTimeout', c = 'setInterval', f = 'clearTimeout', u = '-start',
      d = '-'
    n.exports = i, a.inPlace(window, [ s, 'setImmediate' ], s + d), a.inPlace(window, [ c ], c + d), a.inPlace(window,
      [ f, 'clearImmediate' ], f + d), i.on(c + u, r), i.on(s + u, o)
  }, {} ], 9: [ function (t, n, e) {
    function r (t, n) {
    ...
    if (a.xhrWrappable) {
      ...
      a.features.xhr = !0, t(9), f.on('new-xhr', function (t) {
        var n = this
        n.totalCbs = 0, n.called = 0, n.cbTime = 0, n.end = r, n.ended = !1, n.xhrGuids = {}, n.lastSize = null, p && (p > 34 || p < 10) || window.opera || t.addEventListener(
          'progress',
          function (t) {
            n.lastSize = t.loaded
          },
        ...
        this.startTime = a.now(), this.listener = function (t) {
          try {
            'abort' === t.type && (o.params.aborted = !0), ('load' !== t.type || o.called === o.totalCbs && (o.onloadCalled || 'function' != typeof n.onload)) && o.end(
              n)
          } catch (e) {
            try {
        ...
        this.cbTime += t, n ? this.onloadCalled = !0 : this.called += 1, this.called !== this.totalCbs || !this.onloadCalled && 'function' == typeof e.onload || this.end(
          e)
    ...
    n.exports = function (t) {
      ...
      !r.port && o[ 1 ] && (r.port = o[ 1 ].split('/')[ 0 ].split('@')
        .pop()
        .split(':')[ 1 ]), r.port && '0' !== r.port || (r.port = 'https' === o[ 0 ] ? '443' : '80'), r.hostname = n.hostname || e.hostname, r.pathname = n.pathname, r.protocol = o[ 0 ], '/' !== r.pathname.charAt(
        0) && (r.pathname = '/' + r.pathname)
    ...
    var d = [ 'setPageViewName',
      'setCustomAttribute',
      'setErrorHandler',
      'finished',
      'addToTrace',
      'inlineHit',
      'addRelease' ], l = 'api-', p = l + 'ixn-'
    a(d, function (t, n) {
      u[ n ] = o(l + n, !0, 'api')
    ...
    t(12), l[ p ] ? (l[ p ]('DOMContentLoaded', i, !1), d[ p ]('load', r, !1)) : (l[ h ]('onreadystatechange',
      o), d[ h ]('onload', r)), c('mark', [ 'firstbyte', s ], null, 'api')
    var x = 0, E = t(17)
  }, {} ]
}, {}, [ 'loader', 2, 10, 4, 3 ])
NREUM.info = {
  beacon: 'bam.nr-data.net',
  errorBeacon: 'bam.nr-data.net',
  licenseKey: 'ebe5297fa8',
  applicationID: '102199651',
  sa: 1
}
